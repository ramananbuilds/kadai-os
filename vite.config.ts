...
// Root shim for the Figma Make preview: the web app now lives in apps/web
// (this file's twin there is the standalone config). This config keeps the
// Figma plugins and serves apps/web from the repo root so the sandbox
// preview keeps working while the monorepo migration is underway.
